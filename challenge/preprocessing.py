...
def nifti_to_2d_slices(input_folder: str, output_folder: str, axis: int, filtered, folder,type="ceT1",start=0,end=0):
    all_data = [[],[],[]]
...
if __name__ == "__main__":
    ...
    nifti_to_2d_slices(input_dir, output_dir, axis, do_filter,folder=complete_input_folder,type="ceT1")
